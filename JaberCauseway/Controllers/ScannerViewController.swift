...
class ScannerViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func viewDidLoad() {
        ...
        qrCodeFrameView = UIView(frame: CGRect(x: 50, y: 50, width: 275, height: 275))
        qrCodeFrameView?.center.x = self.view.center.x
        qrCodeFrameView?.center.y = self.view.center.y
